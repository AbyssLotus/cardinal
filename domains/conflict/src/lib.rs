//! # Conflict domain -- Vol. III Ch. 8
//!
//! Owns (Appendix A): grievances, hostility, engagements, morale, terms.
//!
...
/// Fact-type declarations owned by the Conflict domain (Appendix A).
///
...
/// Hermetic transformations owned by the Conflict domain (Vol. V Ch. 3 §3.1).
///
...
/// Proposal-composition validators for Conflict-owned fact types (Vol. IV Ch. 2).
///
