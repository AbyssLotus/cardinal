...
//!
//! Owns (Appendix A): kinship, households, settlements, roles, reputation, membership.
//!
...
/// Fact-type declarations owned by the Society domain (Appendix A).
///
...
/// Proposal-composition validators for Society-owned fact types (Vol. IV Ch. 2).
///
