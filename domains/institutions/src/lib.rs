//! # Institutions domain -- Vol. III Ch. 9
//!
//! Owns (Appendix A): offices, laws, jurisdiction, legitimacy, treaties, succession.
//!
...
/// Fact-type declarations owned by the Institutions domain (Appendix A).
///
...
/// Hermetic transformations owned by the Institutions domain (Vol. V Ch. 3 §3.1).
///
...
/// Proposal-composition validators for Institutions-owned fact types (Vol. IV Ch. 2).
///
