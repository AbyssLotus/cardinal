//! # Knowledge domain -- Vol. III Ch. 7
//!
//! Owns (Appendix A): techniques, knowing, proficiency, records, discovery.
//!
...
/// Fact-type declarations owned by the Knowledge domain (Appendix A).
///
...
/// Hermetic transformations owned by the Knowledge domain (Vol. V Ch. 3 §3.1).
///
...
/// Proposal-composition validators for Knowledge-owned fact types (Vol. IV Ch. 2).
///
