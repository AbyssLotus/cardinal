//! # Ecology domain -- Vol. III Ch. 10
//!
//! Owns (Appendix A): populations, food webs, carrying capacity, migration, individuation.
//!
...
/// Fact-type declarations owned by the Ecology domain (Appendix A).
///
...
/// Hermetic transformations owned by the Ecology domain (Vol. V Ch. 3 §3.1).
///
...
/// Proposal-composition validators for Ecology-owned fact types (Vol. IV Ch. 2).
///
