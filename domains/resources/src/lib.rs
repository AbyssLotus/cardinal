...
//!
//! Owns (Appendix A): definitions, deposits, grades, non-living stocks, regeneration.
//!
...
/// Fact-type declarations owned by the Resources domain (Appendix A).
///
...
/// Proposal-composition validators for Resources-owned fact types (Vol. IV Ch. 2).
///
