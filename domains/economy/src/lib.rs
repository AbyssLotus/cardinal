...
//!
//! Owns (Appendix A): holdings, transfers, exchanges, prices-as-events, money, markets.
//!
...
/// Fact-type declarations owned by the Economy domain (Appendix A).
///
...
/// Proposal-composition validators for Economy-owned fact types (Vol. IV Ch. 2).
///
