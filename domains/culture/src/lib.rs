//! # Culture domain -- Vol. III Ch. 6
//!
//! Owns (Appendix A): values, norms, customs, language, lore, transmission.
//!
...
/// Fact-type declarations owned by the Culture domain (Appendix A).
///
...
/// Hermetic transformations owned by the Culture domain (Vol. V Ch. 3 §3.1).
///
...
/// Proposal-composition validators for Culture-owned fact types (Vol. IV Ch. 2).
///
